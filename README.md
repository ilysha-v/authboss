...
---------------|-----------------------------------------------------------------------------------------------------|------------
Auth           | [github.com/ilysha-v/authboss/auth](https://github.com/go-authboss/authboss/tree/master/auth)           | Provides database password authentication for users.
Confirm        | [github.com/ilysha-v/authboss/confirm](https://github.com/go-authboss/authboss/tree/master/confirm)         | Sends an e-mail verification before allowing users to log in.
Lock           | [github.com/ilysha-v/authboss/lock](https://github.com/go-authboss/authboss/tree/master/lock)               | Locks user accounts after N authentication failures in M time.
OAuth2         | [github.com/ilysha-v/authboss/oauth2](https://github.com/go-authboss/authboss/tree/master/oauth2)           | Provides oauth2 authentication for users.
Recover        | [github.com/ilysha-v/authboss/recover](https://github.com/go-authboss/authboss/tree/master/recover)         | Allows for password resets via e-mail.
Register       | [github.com/ilysha-v/authboss/register](https://github.com/go-authboss/authboss/tree/master/register)       | User-initiated account creation.
Remember       | [github.com/ilysha-v/authboss/remember](https://github.com/go-authboss/authboss/tree/master/remember)       | Persisting login sessions past session cookie expiry.
...
```
go get github.com/ilysha-v/authboss
```

After that a good place to start in any Authboss implementation is the [configuration struct](http://godoc.org/github.com/ilysha-v/authboss#Config).
...
Authboss has the [UpdatePassword](http://godoc.org/github.com/ilysha-v/authboss#Authboss.UpdatePassword) method for you to use. Please consult it's documentation
...
**Requirements:**
- Auth module ([github.com/ilysha-v/authboss/auth](https://github.com/go-authboss/authboss/tree/master/auth))
- [Storer](#storers)
...
**Requirements:**
- OAuth2 module ([github.com/ilysha-v/authboss/oauth2](https://github.com/go-authboss/authboss/tree/master/oauth2))
...
inside the config, this is responsible for returning various information, please see the docs for [OAuth2Provider](http://godoc.org/github.com/ilysha-v/authboss#OAuth2Provider).
...
**Requirements:**
- Register module ([github.com/ilysha-v/authboss/register](https://github.com/go-authboss/authboss/tree/master/register))
...
**Requirements:**
- Register module ([github.com/ilysha-v/authboss/register](https://github.com/go-authboss/authboss/tree/master/register))
- Confirm module ([github.com/ilysha-v/authboss/confirm](https://github.com/go-authboss/authboss/tree/master/confirm))
- [RegisterStorer](#storers)
- [Session and Cookie Storers](#client_storers)
- [Views](#views)
...
**Requirements:**
- Recover module ([github.com/ilysha-v/authboss/recover](https://github.com/go-authboss/authboss/tree/master/recover))
...
**Requirements:**
- Remember module ([github.com/ilysha-v/authboss/remember](https://github.com/go-authboss/authboss/tree/master/remember))
...
**Requirements:**
- Lock module ([github.com/ilysha-v/authboss/lock](https://github.com/go-authboss/authboss/tree/master/lock))
- [Storer](#storers)
...
**Requirements:**
- [ExpireMiddleware](http://godoc.org/github.com/ilysha-v/authboss#Authboss.ExpireMiddleware)
- [Session Storer](#client_storers)
...
[Rules](http://godoc.org/github.com/ilysha-v/authboss#Rules) that you can use instead of writing your own. Validation errors are reported and
...
- [Storer](http://godoc.org/github.com/ilysha-v/authboss#Storer)
- [OAuth2Storer](http://godoc.org/github.com/ilysha-v/authboss#OAuth2Storer)
